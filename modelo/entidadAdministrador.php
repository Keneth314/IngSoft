...
class entidadAdministrador{
    ...
    public function verificarPassword($usuario, $oldpass){
        ...
        $sql = "SELECT usuario FROM administrador WHERE usuario = '$usuario' && password = '$oldpass'";
    ...
    public function actualizarPassword($usuario, $newpass){
        ...
        $sql="UPDATE `administrador` SET `password` ='$newpass' WHERE usuario='$usuario'";
        $query= mysqli_query($con,$sql);
    ...
    public function validarPasswordUsuario($usuario, $password){
        ...
        // Consulta
        $sql = "SELECT usuario
        FROM administrador WHERE usuario = '$usuario'&& password = '$password'";
